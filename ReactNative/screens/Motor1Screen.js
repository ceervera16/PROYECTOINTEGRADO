...
/**
 * Pantalla 1 de la aplicación, que recibe por screenProps:
          ...
          <View style={{flexDirection: 'row'}}>
            <View style={{flex: 0.5}} key={1}>
              <GFrecVar
                ...
                textoPopover={
                  this.props.screenProps.english
                    ? 'Speed ​​of the tape drive'
                    : 'Velocidad del variador de la cinta'
                }
              />
            </View>
            <View style={{flex: 0.5}}>
              <CompOnOff
                ...
                text1={
                  this.props.screenProps.english ? 'On going' : 'En marcha'
                }
                ...
                textoPopover={
                  this.props.screenProps.english
                    ? 'Crusher running or stopped'
                    : 'Trituradora en marcha o parada'
                }
              />
            </View>
          </View>
          <View style={{flexDirection: 'row'}}>
            <View style={{flex: 0.5}}>
              <CompOnOff
                ...
                textoPopover={
                  this.props.screenProps.english
                    ? 'Refill of caps in operation or stopped'
                    : 'Recarga de tapones en funcionamiento o parada'
                }
              />
            </View>
            <View style={{flex: 0.5}}>
